    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground font-arial max-w-3xl mx-auto leading-relaxed my-0 py-0">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16 mt-12 md:items-stretch">
        ...
        {/* Удален ActionSection */}

        {/* Footer */}
        <footer className="border-t border-border/30 mt-20 pt-8 pb-6">
